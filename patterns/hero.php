...
<!-- wp:query {"queryId":0,"query":{"perPage":"1","pages":"1","offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false,"taxQuery":{"label":[5]}},"tagName":"section","displayLayout":{"type":"list","columns":2},"className":"blockhaus-hero","layout":{"type":"default"}} -->
<section class="wp-block-query blockhaus-hero"><!-- wp:post-template -->
<!-- wp:columns {"style":{"spacing":{"blockGap":{"top":"0","left":"0"}}},"className":"bg-neutral-light-100"} -->
<div class="wp-block-columns bg-neutral-light-100"><!-- wp:column {"width":"50%"} -->
