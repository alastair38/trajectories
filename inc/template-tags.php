...
function blockhaus_display_address() {
	...
	$mobile = $phone_numbers['mobile'];
	$mobile_numeric = preg_replace( '/\D/', '', $mobile ); // remove spaces etc from the string
	$work = $phone_numbers['work'];
	$work_numeric = preg_replace( '/\D/', '', $work ); // remove spaces etc from the string
	$alternate = $phone_numbers['alternate'];
	$alternate_numeric = preg_replace( '/\D/', '', $alternate ); // remove spaces etc from the string
	...
	$address .= $mobile ? '<a href="tel:+' . $mobile_numeric . '">Mobile Tel: ' . $mobile . '</a>' : '';
	$address .= $work ? '<a href="tel:+' . $work_numeric . '">Work Tel: ' . $work . '</a>' : '';
	$address .= $alternate ? '<a href="tel:+' . $alternate_numeric . '">Alternate Tel: ' . $alternate . '</a>' : '';
	$address .= '</address>';
...
//	$linkedin = get_field('linkedin', 'options');
	...
	if($youtube['profile_url']) {
		$youtube_profile = '<li class="wp-social-link wp-social-link-youtube wp-block-social-link"><a rel="external" href="' . $youtube['profile_url'] . '" class="wp-block-social-link-anchor"><svg width="24" height="24" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false"><path d="M21.8,8.001c0,0-0.195-1.378-0.795-1.985c-0.76-0.797-1.613-0.801-2.004-0.847c-2.799-0.202-6.997-0.202-6.997-0.202 h-0.009c0,0-4.198,0-6.997,0.202C4.608,5.216,3.756,5.22,2.995,6.016C2.395,6.623,2.2,8.001,2.2,8.001S2,9.62,2,11.238v1.517 c0,1.618,0.2,3.237,0.2,3.237s0.195,1.378,0.795,1.985c0.761,0.797,1.76,0.771,2.205,0.855c1.6,0.153,6.8,0.201,6.8,0.201 s4.203-0.006,7.001-0.209c0.391-0.047,1.243-0.051,2.004-0.847c0.6-0.607,0.795-1.985,0.795-1.985s0.2-1.618,0.2-3.237v-1.517 C22,9.62,21.8,8.001,21.8,8.001z M9.935,14.594l-0.001-5.62l5.404,2.82L9.935,14.594z"></path></svg><span class="wp-block-social-link-label screen-reader-text">YouTube</span></a></li>';
	}
	...
	if($facebook || $instagram || $linkedin || $tiktok || $twitter || $youtube):
		...
		$profiles .= $facebook_profile . $instagram_profile . $tiktok_profile . $twitter_profile . $youtube_profile;
		$profiles .= '</ul>';
	endif;
